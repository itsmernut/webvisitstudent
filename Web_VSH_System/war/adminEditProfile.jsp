                 ...
                 <hr />    
                     ...
                     <div class="colum1">
                         <div class="form-group">
                             <img src="assets/img/user-admin.png" id="img_p3"/>
                                            <p>
                                            <input type="file"/>
                                            </p>
                            </div>
                        ...
                        <div class="form-group">
                            <h4>
                             	ชื่อผู้ใช้งาน <input type="text" class="form-control" value="Admin" />
                            </h4>
                            <h4>
                           	  อีเมล์<input type="email" class="form-control" value="admin_damrong@gmail.com"/>
                            </h4>
                            <h4>
                             	รหัสผ่านเก่า <input type="password" class="form-control" value="123456789"/>
                            </h4>
                            <h4>
                             	รหัสผ่านใหม่ <input type="password" class="form-control" value="123456789"/>
                            </h4>
                            <h4>
                            	 ยืนยันรหัสผ่านใหม่ <input type="password" class="form-control" value="123456789"/>
                            </h4>
                        </div>   
                            <div id="bt">
                            <a href="adminProfile.jsp"><button class="btn btn-default">ยกเลิก</button></a>
                            <button type="submit" class="btn btn-primary" id="bt_submit">ส่ง</button>  
                            </div>
                    </div>            
                </form>
