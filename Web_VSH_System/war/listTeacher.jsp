        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="col-md-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><center><a href="teacherProfile.do?id=${teacher.keyString}"><img src="assets/img/eye-close-up.png"></a></center></td>
                                           
											<td><center><a href="deleteTeacher.do?id=${teacher.keyString}"><img src="assets/img/delete.png"></a></center></td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
                    ...
                    <!--End Advanced Tables -->
                    <a href="newTeacher.do" class="addUser"><img src="assets/img/addUser.png">เพิ่มครู</a>
